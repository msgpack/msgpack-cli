...
namespace MsgPack.Serialization
{
	...
	/// </summary>
	public enum PolymorphismTarget
	{
		/// <summary>
		///		Uses runtime default behavior. 
		///		This means <see cref="Member"/> for non-collection type members and <see cref="CollectionItem"/> for collection type members (<see cref="SerializationContext.DefaultCollectionTypes"/> will be effictive).
		/// </summary>
		Default = 0,
