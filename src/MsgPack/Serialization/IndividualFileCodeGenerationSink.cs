...
{
	/// <summary>
	///		A <see cref="CodeGenerationSink"/> which emits each code to individual files.
	/// </summary>
	internal sealed class IndividualFileCodeGenerationSink : CodeGenerationSink
	{
		internal static readonly IndividualFileCodeGenerationSink Instance = new IndividualFileCodeGenerationSink();
