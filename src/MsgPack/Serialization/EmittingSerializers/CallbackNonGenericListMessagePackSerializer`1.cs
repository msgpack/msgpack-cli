...
{
	/// <summary>
	///		A helper <see cref="NonGenericListMessagePackSerializer{TCollection}"/> for <see cref="DynamicMethodSerializerBuilder{TObject}"/>.
	/// </summary>
	/// <typeparam name="TCollection">The type of the collection.</typeparam>
	internal class CallbackNonGenericListMessagePackSerializer<TCollection> :
		...
		where TCollection : IList
	{
		...
		/// <summary>
		///		Initializes a new instance of the <see cref="CallbackNonGenericListMessagePackSerializer{TCollection}"/> class.
		/// </summary>
