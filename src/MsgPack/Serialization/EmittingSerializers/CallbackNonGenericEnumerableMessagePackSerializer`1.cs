...
{
	/// <summary>
	///		A helper <see cref="NonGenericEnumerableMessagePackSerializer{TCollection}"/> for <see cref="DynamicMethodSerializerBuilder{TObject}"/>.
	/// </summary>
	/// <typeparam name="TCollection">The type of the collection.</typeparam>
	internal class CallbackNonGenericEnumerableMessagePackSerializer<TCollection> :
		...
		where TCollection : IEnumerable
	{
		...
		/// <summary>
		///		Initializes a new instance of the <see cref="CallbackNonGenericEnumerableMessagePackSerializer{TCollection}"/> class.
		/// </summary>
		...
		/// </exception>
		public CallbackNonGenericEnumerableMessagePackSerializer(
