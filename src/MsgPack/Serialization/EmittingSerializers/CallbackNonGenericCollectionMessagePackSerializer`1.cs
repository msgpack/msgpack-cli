...
{
	/// <summary>
	///		A helper <see cref="NonGenericCollectionMessagePackSerializer{TCollection}"/> for <see cref="DynamicMethodSerializerBuilder{TObject}"/>.
	/// </summary>
	/// <typeparam name="TCollection">The type of the collection.</typeparam>
	internal class CallbackNonGenericCollectionMessagePackSerializer<TCollection> :
		...
		where TCollection : ICollection
	{
		...
		/// <summary>
		///		Initializes a new instance of the <see cref="CallbackNonGenericCollectionMessagePackSerializer{TCollection}"/> class.
		/// </summary>
