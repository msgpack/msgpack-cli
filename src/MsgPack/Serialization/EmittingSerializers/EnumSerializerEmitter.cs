...
namespace MsgPack.Serialization.EmittingSerializers
{
	...
	/// </summary>
	internal sealed class EnumSerializerEmitter
	{
		private static readonly Type[] UnpackFromUnderlyingValueParameterTypes = { typeof( MessagePackObject ) };
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="EnumSerializerEmitter"/> class.
		/// </summary>
		...
		public EnumSerializerEmitter( SerializationContext context, ModuleBuilder host, SerializerSpecification specification, bool isDebuggable )
		{
		...
		///		This value will not be <c>null</c>.
		/// </returns>
		public TracingILGenerator GetPackUnderyingValueToMethodILGenerator()
		{
		...
		///		This value will not be <c>null</c>.
		/// </returns>
		public TracingILGenerator GetUnpackFromUnderlyingValueMethodILGenerator()
		{
			if ( SerializerDebugging.TraceEnabled )
			{
		...
		public Func<SerializationContext, EnumSerializationMethod, MessagePackSerializer<T>> CreateConstructor<T>()
		{
