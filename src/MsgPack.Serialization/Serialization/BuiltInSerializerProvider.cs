...
namespace MsgPack.Serialization
{
	...
	internal abstract class BuiltInSerializerProvider
	{
		...
		public IEnumerable<KeyValuePair<RuntimeTypeHandle, Object>> GetSerializers( SerializationContext context )
		{
			return
				this.GetType()
				.GetAssembly()
				...
				.Select( typeInfo=> new KeyValuePair<RuntimeTypeHandle, Object>( typeInfo.AsType().TypeHandle, this.GetSerializer( context, typeInfo.AsType() ) ) );
		}
