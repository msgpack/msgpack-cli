        ...
        protected internal override MsgPack.Serialization.PolymorphicMemberTypeMixed UnpackFromCore(MsgPack.Unpacker unpacker) {
            ...
            if (unpacker.IsArrayHeader) {
                ...
                for (int i = 0; (i < itemsCount0); i = (i + 1)) {
                    ...
                    nullable11 = MsgPack.Serialization.UnpackHelpers.UnpackStringValue(unpacker, typeof(MsgPack.Serialization.PolymorphicMemberTypeMixed), "MemberName");
                    if (((nullable11 == null) 
                                == false)) {
                        key = nullable11;
                    }
                    ...
                    if ((key == "ObjectRuntime")) {
                        object nullable23 = default(object);
                        if ((unpacker.Read() == false)) {
                            throw MsgPack.Serialization.SerializationExceptions.NewMissingItem(i);
                        }
                        if (((unpacker.IsArrayHeader == false) 
                                    && (unpacker.IsMapHeader == false))) {
                            nullable23 = this._serializer20.UnpackFrom(unpacker);
                        }
                        else {
                            MsgPack.Unpacker disposable20 = default(MsgPack.Unpacker);
                            disposable20 = unpacker.ReadSubtree();
                            try {
                                nullable23 = this._serializer20.UnpackFrom(disposable20);
                            }
                            finally {
                        ...
                        if (((nullable23 == null) 
                                    == false)) {
                            result.ObjectRuntime = nullable23;
                        }
                    }
                    else {
                        if ((key == "NormalVanilla")) {
                            string nullable22 = default(string);
                            nullable22 = MsgPack.Serialization.UnpackHelpers.UnpackStringValue(unpacker, typeof(MsgPack.Serialization.PolymorphicMemberTypeMixed), "System.String NormalVanilla");
                            if (((nullable22 == null) 
                                        == false)) {
                                result.NormalVanilla = nullable22;
                            }
                        }
                        else {
                            if ((key == "NormalRuntime")) {
                                ...
                                if (((unpacker.IsArrayHeader == false) 
                                            && (unpacker.IsMapHeader == false))) {
                                    nullable21 = this._serializer18.UnpackFrom(unpacker);
                                }
                                else {
                                    MsgPack.Unpacker disposable19 = default(MsgPack.Unpacker);
                                    disposable19 = unpacker.ReadSubtree();
                                    try {
                                        nullable21 = this._serializer18.UnpackFrom(disposable19);
                                    }
                                    finally {
                                ...
                                if (((nullable21 == null) 
                                            == false)) {
                                    result.NormalRuntime = nullable21;
                                }
                            }
                            else {
                                if ((key == "NormalKnown")) {
                                    MsgPack.Serialization.FileSystemEntry nullable20 = default(MsgPack.Serialization.FileSystemEntry);
                                    if ((unpacker.Read() == false)) {
                                        throw MsgPack.Serialization.SerializationExceptions.NewMissingItem(i);
                                    }
                                    if (((unpacker.IsArrayHeader == false) 
                                                && (unpacker.IsMapHeader == false))) {
                                        nullable20 = this._serializer16.UnpackFrom(unpacker);
                                    }
                                    else {
                                        MsgPack.Unpacker disposable18 = default(MsgPack.Unpacker);
                                        disposable18 = unpacker.ReadSubtree();
                                        try {
                                            nullable20 = this._serializer16.UnpackFrom(disposable18);
                                        }
                                        finally {
                                    ...
                                    if (((nullable20 == null) 
                                                == false)) {
                                        result.NormalKnown = nullable20;
                                    }
                                }
                                else {
                                    if ((key == "ListVanilla")) {
                                        System.Collections.Generic.IList<string> nullable19 = default(System.Collections.Generic.IList<string>);
                                        if ((unpacker.Read() == false)) {
                                            throw MsgPack.Serialization.SerializationExceptions.NewMissingItem(i);
                                        }
                                        if (((unpacker.IsArrayHeader == false) 
                                                    && (unpacker.IsMapHeader == false))) {
                                            nullable19 = this._serializer14.UnpackFrom(unpacker);
                                        }
                                        else {
                                            MsgPack.Unpacker disposable17 = default(MsgPack.Unpacker);
                                            disposable17 = unpacker.ReadSubtree();
                                            try {
                                                nullable19 = this._serializer14.UnpackFrom(disposable17);
                                            }
                                            finally {
                                        ...
                                        if (((nullable19 == null) 
                                                    == false)) {
                                            result.ListVanilla = nullable19;
                                        }
                                    }
                                    else {
                                        if ((key == "ListObjectRuntimeItem")) {
                                            System.Collections.Generic.IList<object> nullable18 = default(System.Collections.Generic.IList<object>);
                                            if ((unpacker.Read() == false)) {
                                                throw MsgPack.Serialization.SerializationExceptions.NewMissingItem(i);
                                            }
                                            if (((unpacker.IsArrayHeader == false) 
                                                        && (unpacker.IsMapHeader == false))) {
                                                nullable18 = this._serializer13.UnpackFrom(unpacker);
                                            }
                                            else {
                                                MsgPack.Unpacker disposable16 = default(MsgPack.Unpacker);
                                                disposable16 = unpacker.ReadSubtree();
                                                try {
                                                    nullable18 = this._serializer13.UnpackFrom(disposable16);
                                                }
                                                finally {
                                            ...
                                            if (((nullable18 == null) 
                                                        == false)) {
                                                result.ListObjectRuntimeItem = nullable18;
                                            }
                                        }
                                        else {
                                            if ((key == "ListKnwonContainerRuntimeItem")) {
                                                ...
                                                if (((unpacker.IsArrayHeader == false) 
                                                            && (unpacker.IsMapHeader == false))) {
                                                    nullable17 = this._serializer11.UnpackFrom(unpacker);
                                                }
                                                else {
                                                    MsgPack.Unpacker disposable15 = default(MsgPack.Unpacker);
                                                    disposable15 = unpacker.ReadSubtree();
                                                    try {
                                                        nullable17 = this._serializer11.UnpackFrom(disposable15);
                                                    }
                                                    finally {
                                                ...
                                                if (((nullable17 == null) 
                                                            == false)) {
                                                    result.ListKnwonContainerRuntimeItem = nullable17;
                                                }
                                            }
                                            else {
                                                if ((key == "ListKnownItem")) {
                                                    System.Collections.Generic.IList<MsgPack.Serialization.FileSystemEntry> nullable16 = default(System.Collections.Generic.IList<MsgPack.Serialization.FileSystemEntry>);
                                                    if ((unpacker.Read() == false)) {
                                                        throw MsgPack.Serialization.SerializationExceptions.NewMissingItem(i);
                                                    }
                                                    if (((unpacker.IsArrayHeader == false) 
                                                                && (unpacker.IsMapHeader == false))) {
                                                        nullable16 = this._serializer9.UnpackFrom(unpacker);
                                                    }
                                                    else {
                                                        MsgPack.Unpacker disposable14 = default(MsgPack.Unpacker);
                                                        disposable14 = unpacker.ReadSubtree();
                                                        try {
                                                            nullable16 = this._serializer9.UnpackFrom(disposable14);
                                                        }
                                                        finally {
                                                    ...
                                                    if (((nullable16 == null) 
                                                                == false)) {
                                                        result.ListKnownItem = nullable16;
                                                    }
                                                }
                                                else {
                                                    if ((key == "DictionaryVanilla")) {
                                                        System.Collections.Generic.IDictionary<string, string> nullable15 = default(System.Collections.Generic.IDictionary<string, string>);
                                                        if ((unpacker.Read() == false)) {
                                                            throw MsgPack.Serialization.SerializationExceptions.NewMissingItem(i);
                                                        }
                                                        if (((unpacker.IsArrayHeader == false) 
                                                                    && (unpacker.IsMapHeader == false))) {
                                                            nullable15 = this._serializer7.UnpackFrom(unpacker);
                                                        }
                                                        else {
                                                            MsgPack.Unpacker disposable13 = default(MsgPack.Unpacker);
                                                            disposable13 = unpacker.ReadSubtree();
                                                            try {
                                                                nullable15 = this._serializer7.UnpackFrom(disposable13);
                                                            }
                                                            finally {
                                                        ...
                                                        if (((nullable15 == null) 
                                                                    == false)) {
                                                            result.DictionaryVanilla = nullable15;
                                                        }
                                                    }
                                                    else {
                                                        if ((key == "DictionaryObjectRuntimeValue")) {
                                                            System.Collections.Generic.IDictionary<string, object> nullable14 = default(System.Collections.Generic.IDictionary<string, object>);
                                                            if ((unpacker.Read() == false)) {
                                                                throw MsgPack.Serialization.SerializationExceptions.NewMissingItem(i);
                                                            }
                                                            if (((unpacker.IsArrayHeader == false) 
                                                                        && (unpacker.IsMapHeader == false))) {
                                                                nullable14 = this._serializer5.UnpackFrom(unpacker);
                                                            }
                                                            else {
                                                                MsgPack.Unpacker disposable12 = default(MsgPack.Unpacker);
                                                                disposable12 = unpacker.ReadSubtree();
                                                                try {
                                                                    nullable14 = this._serializer5.UnpackFrom(disposable12);
                                                                }
                                                                finally {
                                                            ...
                                                            if (((nullable14 == null) 
                                                                        == false)) {
                                                                result.DictionaryObjectRuntimeValue = nullable14;
                                                            }
                                                        }
                                                        else {
                                                            if ((key == "DictionaryKnownValue")) {
                                                                ...
                                                                if (((unpacker.IsArrayHeader == false) 
                                                                    ...
                                                                    try {
                                                                        nullable13 = this._serializer3.UnpackFrom(disposable11);
                                                                    }
                                                                    finally {
                                                                ...
                                                                if (((nullable13 == null) 
                                                                            == false)) {
                                                                    result.DictionaryKnownValue = nullable13;
                                                                }
                                                            }
                                                            else {
                                                                if ((key == "DictionaryKnownContainerRuntimeValue")) {
                                                                    System.Collections.Generic.IDictionary<string, MsgPack.Serialization.FileSystemEntry> nullable12 = default(System.Collections.Generic.IDictionary<string, MsgPack.Serialization.FileSystemEntry>);
                                                                    if ((unpacker.Read() == false)) {
                                                                        throw MsgPack.Serialization.SerializationExceptions.NewMissingItem(i);
                                                                    }
                                                                    if (((unpacker.IsArrayHeader == false) 
                                                                                && (unpacker.IsMapHeader == false))) {
                                                                        nullable12 = this._serializer1.UnpackFrom(unpacker);
                                                                    }
                                                                    else {
                                                                        MsgPack.Unpacker disposable10 = default(MsgPack.Unpacker);
                                                                        disposable10 = unpacker.ReadSubtree();
                                                                        try {
                                                                            nullable12 = this._serializer1.UnpackFrom(disposable10);
                                                                        }
                                                                        finally {
                                                                    ...
                                                                    if (((nullable12 == null) 
                                                                                == false)) {
                                                                        result.DictionaryKnownContainerRuntimeValue = nullable12;
                                                                    }
                                                                }
                                                                else {
                                                                    unpacker.Skip();
