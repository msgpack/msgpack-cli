...
namespace MsgPack.Serialization.GeneratedSerializers.MapBased {
    ...
    public class MsgPack_Serialization_AbstractClassMemberKnownTypeSerializer : MsgPack.Serialization.MessagePackSerializer<MsgPack.Serialization.AbstractClassMemberKnownType> {
        ...
        private MsgPack.Serialization.MessagePackSerializer<MsgPack.Serialization.AbstractFileSystemEntry> _serializer1;
        ...
        public MsgPack_Serialization_AbstractClassMemberKnownTypeSerializer(MsgPack.Serialization.SerializationContext context) : 
            ...
            typeMap1 = new System.Collections.Generic.Dictionary<byte, System.Type>(1);
            typeMap1.Add(1, typeof(MsgPack.Serialization.FileEntry));
            schema1 = MsgPack.Serialization.PolymorphismSchema.ForPolymorphicObject(typeof(MsgPack.Serialization.AbstractFileSystemEntry), typeMap1);
            this._serializer1 = context.GetSerializer<MsgPack.Serialization.AbstractFileSystemEntry>(schema1);
        }
        ...
        protected internal override MsgPack.Serialization.AbstractClassMemberKnownType UnpackFromCore(MsgPack.Unpacker unpacker) {
            ...
            if (unpacker.IsArrayHeader) {
                ...
                for (int i = 0; (i < itemsCount0); i = (i + 1)) {
                    ...
                    nullable0 = MsgPack.Serialization.UnpackHelpers.UnpackStringValue(unpacker, typeof(MsgPack.Serialization.AbstractClassMemberKnownType), "MemberName");
                    if (((nullable0 == null) 
                                == false)) {
                        key = nullable0;
                    }
                    ...
                    if ((key == "Value")) {
                        MsgPack.Serialization.AbstractFileSystemEntry nullable1 = default(MsgPack.Serialization.AbstractFileSystemEntry);
                        if ((unpacker.Read() == false)) {
