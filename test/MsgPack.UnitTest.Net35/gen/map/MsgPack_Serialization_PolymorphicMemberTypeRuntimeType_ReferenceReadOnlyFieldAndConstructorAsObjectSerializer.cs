    ...
    public class MsgPack_Serialization_PolymorphicMemberTypeRuntimeType_ReferenceReadOnlyFieldAndConstructorAsObjectSerializer : MsgPack.Serialization.MessagePackSerializer<MsgPack.Serialization.PolymorphicMemberTypeRuntimeType_ReferenceReadOnlyFieldAndConstructorAsObject> {
        ...
        protected internal override MsgPack.Serialization.PolymorphicMemberTypeRuntimeType_ReferenceReadOnlyFieldAndConstructorAsObject UnpackFromCore(MsgPack.Unpacker unpacker) {
            ...
            if (unpacker.IsArrayHeader) {
                ...
                unpacked = (unpacked + 1);
                result = new MsgPack.Serialization.PolymorphicMemberTypeRuntimeType_ReferenceReadOnlyFieldAndConstructorAsObject(ctorArg0);
            }
            else {
                ...
                for (int i = 0; (i < itemsCount0); i = (i + 1)) {
                    ...
                    nullable0 = MsgPack.Serialization.UnpackHelpers.UnpackStringValue(unpacker, typeof(MsgPack.Serialization.PolymorphicMemberTypeRuntimeType_ReferenceReadOnlyFieldAndConstructorAsObject), "MemberName");
                    if (((nullable0 == null) 
                                == false)) {
                        key = nullable0;
                    }
                ...
                result = new MsgPack.Serialization.PolymorphicMemberTypeRuntimeType_ReferenceReadOnlyFieldAndConstructorAsObject(ctorArg00);
            }
            return result;
        }
