...
namespace MsgPack.Serialization.GeneratedSerializers.MapBased {
    ...
    public class MsgPack_Serialization_AnnotatedClassSerializer : MsgPack.Serialization.MessagePackSerializer<MsgPack.Serialization.AnnotatedClass> {
        ...
        private System.Collections.Generic.IList<System.Action<MsgPack.Unpacker, MsgPack.Serialization.AnnotatedClass, int>> _unpackOperationList;
        
        private System.Collections.Generic.IDictionary<string, System.Action<MsgPack.Unpacker, MsgPack.Serialization.AnnotatedClass, int>> _unpackOperationTable;
        ...
        public MsgPack_Serialization_AnnotatedClassSerializer(MsgPack.Serialization.SerializationContext context) : 
            ...
            System.Action<MsgPack.Unpacker, MsgPack.Serialization.AnnotatedClass, int>[] unpackOperationList = default(System.Action<MsgPack.Unpacker, MsgPack.Serialization.AnnotatedClass, int>[]);
            unpackOperationList = new System.Action<MsgPack.Unpacker, MsgPack.Serialization.AnnotatedClass, int>[10];
            unpackOperationList[0] = new System.Action<MsgPack.Unpacker, MsgPack.Serialization.AnnotatedClass, int>(this.UnpackValueOfAlias);
            unpackOperationList[1] = new System.Action<MsgPack.Unpacker, MsgPack.Serialization.AnnotatedClass, int>(this.UnpackValueOfPublicField);
            unpackOperationList[2] = new System.Action<MsgPack.Unpacker, MsgPack.Serialization.AnnotatedClass, int>(this.UnpackMemberPlaceHolder);
            unpackOperationList[3] = new System.Action<MsgPack.Unpacker, MsgPack.Serialization.AnnotatedClass, int>(this.UnpackMemberPlaceHolder);
            unpackOperationList[4] = new System.Action<MsgPack.Unpacker, MsgPack.Serialization.AnnotatedClass, int>(this.UnpackValueOfNonPublicProperty);
            unpackOperationList[5] = new System.Action<MsgPack.Unpacker, MsgPack.Serialization.AnnotatedClass, int>(this.UnpackValueOfNonPublicField);
            unpackOperationList[6] = new System.Action<MsgPack.Unpacker, MsgPack.Serialization.AnnotatedClass, int>(this.UnpackValueOfNonSerializedPublicField);
            unpackOperationList[7] = new System.Action<MsgPack.Unpacker, MsgPack.Serialization.AnnotatedClass, int>(this.UnpackMemberPlaceHolder);
            unpackOperationList[8] = new System.Action<MsgPack.Unpacker, MsgPack.Serialization.AnnotatedClass, int>(this.UnpackValueOfNonSerializedNonPublicField);
            unpackOperationList[9] = new System.Action<MsgPack.Unpacker, MsgPack.Serialization.AnnotatedClass, int>(this.UnpackValueOfCollectionReadOnlyProperty);
            this._unpackOperationList = unpackOperationList;
            System.Collections.Generic.Dictionary<string, System.Action<MsgPack.Unpacker, MsgPack.Serialization.AnnotatedClass, int>> unpackOperationTable = default(System.Collections.Generic.Dictionary<string, System.Action<MsgPack.Unpacker, MsgPack.Serialization.AnnotatedClass, int>>);
            unpackOperationTable = new System.Collections.Generic.Dictionary<string, System.Action<MsgPack.Unpacker, MsgPack.Serialization.AnnotatedClass, int>>(7);
            unpackOperationTable["Alias"] = new System.Action<MsgPack.Unpacker, MsgPack.Serialization.AnnotatedClass, int>(this.UnpackValueOfAlias);
            unpackOperationTable["PublicField"] = new System.Action<MsgPack.Unpacker, MsgPack.Serialization.AnnotatedClass, int>(this.UnpackValueOfPublicField);
            unpackOperationTable["NonPublicProperty"] = new System.Action<MsgPack.Unpacker, MsgPack.Serialization.AnnotatedClass, int>(this.UnpackValueOfNonPublicProperty);
            unpackOperationTable["NonPublicField"] = new System.Action<MsgPack.Unpacker, MsgPack.Serialization.AnnotatedClass, int>(this.UnpackValueOfNonPublicField);
            unpackOperationTable["NonSerializedPublicField"] = new System.Action<MsgPack.Unpacker, MsgPack.Serialization.AnnotatedClass, int>(this.UnpackValueOfNonSerializedPublicField);
            unpackOperationTable["NonSerializedNonPublicField"] = new System.Action<MsgPack.Unpacker, MsgPack.Serialization.AnnotatedClass, int>(this.UnpackValueOfNonSerializedNonPublicField);
            unpackOperationTable["CollectionReadOnlyProperty"] = new System.Action<MsgPack.Unpacker, MsgPack.Serialization.AnnotatedClass, int>(this.UnpackValueOfCollectionReadOnlyProperty);
        ...
        private void UnpackValueOfAlias(MsgPack.Unpacker unpacker, MsgPack.Serialization.AnnotatedClass unpackingContext, int indexOfItem) {
            System.Nullable<int> nullable = default(System.Nullable<int>);
            nullable = MsgPack.Serialization.UnpackHelpers.UnpackNullableInt32Value(unpacker, typeof(MsgPack.Serialization.AnnotatedClass), "PublicProperty");
            if (nullable.HasValue) {
                unpackingContext.PublicProperty = nullable.Value;
            }
        }
        
        private void UnpackValueOfPublicField(MsgPack.Unpacker unpacker, MsgPack.Serialization.AnnotatedClass unpackingContext, int indexOfItem) {
            System.Nullable<int> nullable0 = default(System.Nullable<int>);
            nullable0 = MsgPack.Serialization.UnpackHelpers.UnpackNullableInt32Value(unpacker, typeof(MsgPack.Serialization.AnnotatedClass), "PublicField");
            if (nullable0.HasValue) {
                unpackingContext.PublicField = nullable0.Value;
            }
        }
        
        private void UnpackMemberPlaceHolder(MsgPack.Unpacker unpacker, MsgPack.Serialization.AnnotatedClass unpackingContext, int indexOfItem) {
            unpacker.Read();
        }
        
        private void UnpackValueOfNonPublicProperty(MsgPack.Unpacker unpacker, MsgPack.Serialization.AnnotatedClass unpackingContext, int indexOfItem) {
            System.Nullable<int> nullable1 = default(System.Nullable<int>);
            nullable1 = MsgPack.Serialization.UnpackHelpers.UnpackNullableInt32Value(unpacker, typeof(MsgPack.Serialization.AnnotatedClass), "NonPublicProperty");
        ...
        private void UnpackValueOfNonPublicField(MsgPack.Unpacker unpacker, MsgPack.Serialization.AnnotatedClass unpackingContext, int indexOfItem) {
            System.Nullable<int> nullable2 = default(System.Nullable<int>);
            nullable2 = MsgPack.Serialization.UnpackHelpers.UnpackNullableInt32Value(unpacker, typeof(MsgPack.Serialization.AnnotatedClass), "NonPublicField");
            if (nullable2.HasValue) {
                this._fieldAnnotatedClass_NonPublicField0.SetValue(unpackingContext, ((object)(nullable2.Value)));
            }
        }
        
        private void UnpackValueOfNonSerializedPublicField(MsgPack.Unpacker unpacker, MsgPack.Serialization.AnnotatedClass unpackingContext, int indexOfItem) {
            System.Nullable<int> nullable3 = default(System.Nullable<int>);
            nullable3 = MsgPack.Serialization.UnpackHelpers.UnpackNullableInt32Value(unpacker, typeof(MsgPack.Serialization.AnnotatedClass), "NonSerializedPublicField");
            if (nullable3.HasValue) {
                unpackingContext.NonSerializedPublicField = nullable3.Value;
            }
        }
        
        private void UnpackValueOfNonSerializedNonPublicField(MsgPack.Unpacker unpacker, MsgPack.Serialization.AnnotatedClass unpackingContext, int indexOfItem) {
            System.Nullable<int> nullable4 = default(System.Nullable<int>);
            nullable4 = MsgPack.Serialization.UnpackHelpers.UnpackNullableInt32Value(unpacker, typeof(MsgPack.Serialization.AnnotatedClass), "NonSerializedNonPublicField");
            if (nullable4.HasValue) {
                this._fieldAnnotatedClass_NonSerializedNonPublicField1.SetValue(unpackingContext, ((object)(nullable4.Value)));
            }
        }
        
        private void UnpackValueOfCollectionReadOnlyProperty(MsgPack.Unpacker unpacker, MsgPack.Serialization.AnnotatedClass unpackingContext, int indexOfItem) {
