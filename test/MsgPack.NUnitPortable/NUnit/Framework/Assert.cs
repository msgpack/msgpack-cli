...
namespace NUnit.Framework
{
    ...
    public class Assert
    {
        ...
        public static new bool Equals(object a, object b)
        {
			...
			TestingPlatform.EnsureInitialized().Fail( "Assert.Equals should not be used for Assertions" );
			return false;
        }
        ...
        {
			TestingPlatform.EnsureInitialized().Fail( "Assert.ReferenceEquals should not be used for Assertions" );
        }
        ...
        static public void Pass(string message, params object[] args)
        {
			...
			TestingPlatform.EnsureInitialized().Success( message );
        }
        ...
        static public void Fail(string message, params object[] args)
        {
			...
			TestingPlatform.EnsureInitialized().Fail( message );
        }
        ...
        static public void Ignore(string message, params object[] args)
        {
            ...
            TestingPlatform.EnsureInitialized().Ignore(message);
        }
        ...
        static public void Inconclusive(string message, params object[] args)
        {
            ...
            TestingPlatform.EnsureInitialized().Inconclusive(message);
        }
        ...
        static public void That(object actual, IResolveConstraint expression, string message, params object[] args)
        {
            ...
            if (!constraint.Matches(actual))
            {
                ...
                TestingPlatform.EnsureInitialized().Fail(writer.ToString());
            }
        }
        #endregion
