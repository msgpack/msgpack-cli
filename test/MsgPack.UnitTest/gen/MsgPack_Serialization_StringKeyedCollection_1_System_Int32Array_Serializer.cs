...
namespace MsgPack.Serialization.GeneratedSerializers {
    ...
    public class MsgPack_Serialization_StringKeyedCollection_1_System_Int32Array_Serializer : MsgPack.Serialization.CollectionSerializers.CollectionMessagePackSerializer<MsgPack.Serialization.StringKeyedCollection<int[]>, int[]> {
        ...
        public MsgPack_Serialization_StringKeyedCollection_1_System_Int32Array_Serializer(MsgPack.Serialization.SerializationContext context) : 
                base(context, MsgPack_Serialization_StringKeyedCollection_1_System_Int32Array_Serializer.RestoreSchema(), ((MsgPack.Serialization.SerializerCapabilities.PackTo | MsgPack.Serialization.SerializerCapabilities.UnpackFrom) 
                                | MsgPack.Serialization.SerializerCapabilities.UnpackTo)) {
        }
        
        protected override MsgPack.Serialization.StringKeyedCollection<int[]> CreateInstance(int initialCapacity) {
