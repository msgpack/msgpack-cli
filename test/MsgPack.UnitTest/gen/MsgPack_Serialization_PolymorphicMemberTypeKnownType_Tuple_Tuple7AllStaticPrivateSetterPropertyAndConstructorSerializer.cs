...
namespace MsgPack.Serialization.GeneratedSerializers {
    ...
    public class MsgPack_Serialization_PolymorphicMemberTypeKnownType_Tuple_Tuple7AllStaticPrivateSetterPropertyAndConstructorSerializer : MsgPack.Serialization.MessagePackSerializer<MsgPack.Serialization.PolymorphicMemberTypeKnownType_Tuple_Tuple7AllStaticPrivateSetterPropertyAndConstructor> {
        ...
        private System.Action<MsgPack.Packer, MsgPack.Serialization.PolymorphicMemberTypeKnownType_Tuple_Tuple7AllStaticPrivateSetterPropertyAndConstructor> this_PackValueOfTuple7AllStaticPackValueOfTuple7AllStaticDelegate;
        ...
        private System.Action<MsgPack.Serialization.PolymorphicMemberTypeKnownType_Tuple_Tuple7AllStaticPrivateSetterPropertyAndConstructor, System.Tuple<string, string, string, string, string, string, string>> this_SetUnpackedValueOfTuple7AllStaticSetUnpackedValueOfTuple7AllStaticDelegate;
        
        private System.Action<MsgPack.Unpacker, MsgPack.Serialization.PolymorphicMemberTypeKnownType_Tuple_Tuple7AllStaticPrivateSetterPropertyAndConstructor, int, int> this_UnpackValueOfTuple7AllStaticUnpackValueOfTuple7AllStaticDelegate;
        ...
        public MsgPack_Serialization_PolymorphicMemberTypeKnownType_Tuple_Tuple7AllStaticPrivateSetterPropertyAndConstructorSerializer(MsgPack.Serialization.SerializationContext context) : 
            ...
            this._memberNames = new string[] {
                    "Tuple7AllStatic"};
            this.this_PackValueOfTuple7AllStaticPackValueOfTuple7AllStaticDelegate = new System.Action<MsgPack.Packer, MsgPack.Serialization.PolymorphicMemberTypeKnownType_Tuple_Tuple7AllStaticPrivateSetterPropertyAndConstructor>(this.PackValueOfTuple7AllStatic);
            this.this_SetUnpackedValueOfTuple7AllStaticSetUnpackedValueOfTuple7AllStaticDelegate = new System.Action<MsgPack.Serialization.PolymorphicMemberTypeKnownType_Tuple_Tuple7AllStaticPrivateSetterPropertyAndConstructor, System.Tuple<string, string, string, string, string, string, string>>(this.SetUnpackedValueOfTuple7AllStatic);
            this.this_UnpackValueOfTuple7AllStaticUnpackValueOfTuple7AllStaticDelegate = new System.Action<MsgPack.Unpacker, MsgPack.Serialization.PolymorphicMemberTypeKnownType_Tuple_Tuple7AllStaticPrivateSetterPropertyAndConstructor, int, int>(this.UnpackValueOfTuple7AllStatic);
        }
