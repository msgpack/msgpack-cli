        ...
        protected internal override MsgPack.Serialization.PolymorphicMemberTypeRuntimeType_Dict_DictObjectKeyAndItemReadOnlyCollectionField UnpackFromCore(MsgPack.Unpacker unpacker) {
            ...
            if (unpacker.IsArrayHeader) {
                ...
                for (int i = 0; (i < itemsCount0); i = (i + 1)) {
                    ...
                    nullable0 = MsgPack.Serialization.UnpackHelpers.UnpackStringValue(unpacker, typeof(MsgPack.Serialization.PolymorphicMemberTypeRuntimeType_Dict_DictObjectKeyAndItemReadOnlyCollectionField), "MemberName");
                    if (((nullable0 == null) 
                                == false)) {
                        key = nullable0;
                    }
