...
namespace MsgPack.Serialization.GeneratedSerializers.MapBased {
    ...
    public class MsgPack_Serialization_AbstractClassDictKeyRuntimeTypeSerializer : MsgPack.Serialization.MessagePackSerializer<MsgPack.Serialization.AbstractClassDictKeyRuntimeType> {
        ...
        private System.Collections.Generic.IList<System.Action<MsgPack.Unpacker, MsgPack.Serialization.AbstractClassDictKeyRuntimeType, int>> _unpackOperationList;
        
        private System.Collections.Generic.IDictionary<string, System.Action<MsgPack.Unpacker, MsgPack.Serialization.AbstractClassDictKeyRuntimeType, int>> _unpackOperationTable;
        ...
        public MsgPack_Serialization_AbstractClassDictKeyRuntimeTypeSerializer(MsgPack.Serialization.SerializationContext context) : 
            ...
            System.Action<MsgPack.Unpacker, MsgPack.Serialization.AbstractClassDictKeyRuntimeType, int>[] unpackOperationList = default(System.Action<MsgPack.Unpacker, MsgPack.Serialization.AbstractClassDictKeyRuntimeType, int>[]);
            unpackOperationList = new System.Action<MsgPack.Unpacker, MsgPack.Serialization.AbstractClassDictKeyRuntimeType, int>[1];
            unpackOperationList[0] = new System.Action<MsgPack.Unpacker, MsgPack.Serialization.AbstractClassDictKeyRuntimeType, int>(this.UnpackValueOfValue);
            this._unpackOperationList = unpackOperationList;
            System.Collections.Generic.Dictionary<string, System.Action<MsgPack.Unpacker, MsgPack.Serialization.AbstractClassDictKeyRuntimeType, int>> unpackOperationTable = default(System.Collections.Generic.Dictionary<string, System.Action<MsgPack.Unpacker, MsgPack.Serialization.AbstractClassDictKeyRuntimeType, int>>);
            unpackOperationTable = new System.Collections.Generic.Dictionary<string, System.Action<MsgPack.Unpacker, MsgPack.Serialization.AbstractClassDictKeyRuntimeType, int>>(1);
            unpackOperationTable["Value"] = new System.Action<MsgPack.Unpacker, MsgPack.Serialization.AbstractClassDictKeyRuntimeType, int>(this.UnpackValueOfValue);
        ...
        private void UnpackValueOfValue(MsgPack.Unpacker unpacker, MsgPack.Serialization.AbstractClassDictKeyRuntimeType unpackingContext, int indexOfItem) {
