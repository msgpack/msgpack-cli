            ...
            if (unpacker.IsArrayHeader) {
                ...
                if (((nullable == null) 
                    ...
                    if ((result.ListStaticItem == null)) {
                        this._methodBasePolymorphicMemberTypeKnownType_List_ListStaticItemPrivateSetterCollectionProperty_set_ListStaticItem0.Invoke(result, new object[] {
                                    nullable});
                    }
                    else {
                ...
                for (int i = 0; (i < itemsCount0); i = (i + 1)) {
                    ...
                    nullable0 = MsgPack.Serialization.UnpackHelpers.UnpackStringValue(unpacker, typeof(MsgPack.Serialization.PolymorphicMemberTypeKnownType_List_ListStaticItemPrivateSetterCollectionProperty), "MemberName");
                    if (((nullable0 == null) 
                                == false)) {
                        key = nullable0;
                    }
