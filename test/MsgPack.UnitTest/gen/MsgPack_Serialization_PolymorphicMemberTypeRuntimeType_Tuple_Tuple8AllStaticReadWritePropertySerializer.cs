...
namespace MsgPack.Serialization.GeneratedSerializers {
    ...
    public class MsgPack_Serialization_PolymorphicMemberTypeRuntimeType_Tuple_Tuple8AllStaticReadWritePropertySerializer : MsgPack.Serialization.MessagePackSerializer<MsgPack.Serialization.PolymorphicMemberTypeRuntimeType_Tuple_Tuple8AllStaticReadWriteProperty> {
        ...
        private System.Action<MsgPack.Packer, MsgPack.Serialization.PolymorphicMemberTypeRuntimeType_Tuple_Tuple8AllStaticReadWriteProperty> this_PackValueOfTuple8AllStaticPackValueOfTuple8AllStaticDelegate;
        ...
        private System.Action<MsgPack.Serialization.PolymorphicMemberTypeRuntimeType_Tuple_Tuple8AllStaticReadWriteProperty, System.Tuple<string, string, string, string, string, string, string, System.Tuple<string>>> this_SetUnpackedValueOfTuple8AllStaticSetUnpackedValueOfTuple8AllStaticDelegate;
        
        private System.Action<MsgPack.Unpacker, MsgPack.Serialization.PolymorphicMemberTypeRuntimeType_Tuple_Tuple8AllStaticReadWriteProperty, int, int> this_UnpackValueOfTuple8AllStaticUnpackValueOfTuple8AllStaticDelegate;
        ...
        public MsgPack_Serialization_PolymorphicMemberTypeRuntimeType_Tuple_Tuple8AllStaticReadWritePropertySerializer(MsgPack.Serialization.SerializationContext context) : 
            ...
            this._memberNames = new string[] {
                    "Tuple8AllStatic"};
            this.this_PackValueOfTuple8AllStaticPackValueOfTuple8AllStaticDelegate = new System.Action<MsgPack.Packer, MsgPack.Serialization.PolymorphicMemberTypeRuntimeType_Tuple_Tuple8AllStaticReadWriteProperty>(this.PackValueOfTuple8AllStatic);
            this.this_SetUnpackedValueOfTuple8AllStaticSetUnpackedValueOfTuple8AllStaticDelegate = new System.Action<MsgPack.Serialization.PolymorphicMemberTypeRuntimeType_Tuple_Tuple8AllStaticReadWriteProperty, System.Tuple<string, string, string, string, string, string, string, System.Tuple<string>>>(this.SetUnpackedValueOfTuple8AllStatic);
            this.this_UnpackValueOfTuple8AllStaticUnpackValueOfTuple8AllStaticDelegate = new System.Action<MsgPack.Unpacker, MsgPack.Serialization.PolymorphicMemberTypeRuntimeType_Tuple_Tuple8AllStaticReadWriteProperty, int, int>(this.UnpackValueOfTuple8AllStatic);
        }
