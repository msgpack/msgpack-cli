...
namespace MsgPack.Serialization.GeneratedSerializers {
    ...
    public class MsgPack_Serialization_InterfaceListItemRuntimeTypeSerializer : MsgPack.Serialization.MessagePackSerializer<MsgPack.Serialization.InterfaceListItemRuntimeType> {
        ...
        private System.Action<MsgPack.Packer, MsgPack.Serialization.InterfaceListItemRuntimeType> this_PackValueOfValuePackValueOfValueDelegate;
        ...
        private System.Action<MsgPack.Serialization.InterfaceListItemRuntimeType, System.Collections.Generic.IList<MsgPack.Serialization.IFileSystemEntry>> this_SetUnpackedValueOfValueSetUnpackedValueOfValueDelegate;
        
        private System.Action<MsgPack.Unpacker, MsgPack.Serialization.InterfaceListItemRuntimeType, int, int> this_UnpackValueOfValueUnpackValueOfValueDelegate;
        ...
        public MsgPack_Serialization_InterfaceListItemRuntimeTypeSerializer(MsgPack.Serialization.SerializationContext context) : 
            ...
            this._memberNames = new string[] {
                    "Value"};
            this.this_PackValueOfValuePackValueOfValueDelegate = new System.Action<MsgPack.Packer, MsgPack.Serialization.InterfaceListItemRuntimeType>(this.PackValueOfValue);
            this.this_SetUnpackedValueOfValueSetUnpackedValueOfValueDelegate = new System.Action<MsgPack.Serialization.InterfaceListItemRuntimeType, System.Collections.Generic.IList<MsgPack.Serialization.IFileSystemEntry>>(this.SetUnpackedValueOfValue);
            this.this_UnpackValueOfValueUnpackValueOfValueDelegate = new System.Action<MsgPack.Unpacker, MsgPack.Serialization.InterfaceListItemRuntimeType, int, int>(this.UnpackValueOfValue);
        }
        ...
        private void UnpackValueOfValue(MsgPack.Unpacker unpacker, MsgPack.Serialization.InterfaceListItemRuntimeType unpackingContext, int indexOfItem, int itemsCount) {
            MsgPack.Serialization.UnpackHelpers.UnpackReferenceTypeValue(unpacker, unpackingContext, this._serializer0, itemsCount, indexOfItem, typeof(System.Collections.Generic.IList<MsgPack.Serialization.IFileSystemEntry>), "Value", MsgPack.Serialization.NilImplication.MemberDefault, null, this.this_SetUnpackedValueOfValueSetUnpackedValueOfValueDelegate);
        }
