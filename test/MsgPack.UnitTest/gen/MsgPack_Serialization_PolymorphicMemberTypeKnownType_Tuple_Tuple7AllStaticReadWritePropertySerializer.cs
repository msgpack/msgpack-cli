...
namespace MsgPack.Serialization.GeneratedSerializers {
    ...
    public class MsgPack_Serialization_PolymorphicMemberTypeKnownType_Tuple_Tuple7AllStaticReadWritePropertySerializer : MsgPack.Serialization.MessagePackSerializer<MsgPack.Serialization.PolymorphicMemberTypeKnownType_Tuple_Tuple7AllStaticReadWriteProperty> {
        ...
        private System.Action<MsgPack.Packer, MsgPack.Serialization.PolymorphicMemberTypeKnownType_Tuple_Tuple7AllStaticReadWriteProperty> this_PackValueOfTuple7AllStaticPackValueOfTuple7AllStaticDelegate;
        ...
        private System.Action<MsgPack.Serialization.PolymorphicMemberTypeKnownType_Tuple_Tuple7AllStaticReadWriteProperty, System.Tuple<string, string, string, string, string, string, string>> this_SetUnpackedValueOfTuple7AllStaticSetUnpackedValueOfTuple7AllStaticDelegate;
        
        private System.Action<MsgPack.Unpacker, MsgPack.Serialization.PolymorphicMemberTypeKnownType_Tuple_Tuple7AllStaticReadWriteProperty, int, int> this_UnpackValueOfTuple7AllStaticUnpackValueOfTuple7AllStaticDelegate;
        ...
        public MsgPack_Serialization_PolymorphicMemberTypeKnownType_Tuple_Tuple7AllStaticReadWritePropertySerializer(MsgPack.Serialization.SerializationContext context) : 
            ...
            this._memberNames = new string[] {
                    "Tuple7AllStatic"};
            this.this_PackValueOfTuple7AllStaticPackValueOfTuple7AllStaticDelegate = new System.Action<MsgPack.Packer, MsgPack.Serialization.PolymorphicMemberTypeKnownType_Tuple_Tuple7AllStaticReadWriteProperty>(this.PackValueOfTuple7AllStatic);
            this.this_SetUnpackedValueOfTuple7AllStaticSetUnpackedValueOfTuple7AllStaticDelegate = new System.Action<MsgPack.Serialization.PolymorphicMemberTypeKnownType_Tuple_Tuple7AllStaticReadWriteProperty, System.Tuple<string, string, string, string, string, string, string>>(this.SetUnpackedValueOfTuple7AllStatic);
            this.this_UnpackValueOfTuple7AllStaticUnpackValueOfTuple7AllStaticDelegate = new System.Action<MsgPack.Unpacker, MsgPack.Serialization.PolymorphicMemberTypeKnownType_Tuple_Tuple7AllStaticReadWriteProperty, int, int>(this.UnpackValueOfTuple7AllStatic);
        }
