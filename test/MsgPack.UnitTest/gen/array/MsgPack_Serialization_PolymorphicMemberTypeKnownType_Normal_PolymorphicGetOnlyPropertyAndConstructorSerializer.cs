    ...
    public class MsgPack_Serialization_PolymorphicMemberTypeKnownType_Normal_PolymorphicGetOnlyPropertyAndConstructorSerializer : MsgPack.Serialization.MessagePackSerializer<MsgPack.Serialization.PolymorphicMemberTypeKnownType_Normal_PolymorphicGetOnlyPropertyAndConstructor> {
        ...
        protected internal override MsgPack.Serialization.PolymorphicMemberTypeKnownType_Normal_PolymorphicGetOnlyPropertyAndConstructor UnpackFromCore(MsgPack.Unpacker unpacker) {
            ...
            if (unpacker.IsArrayHeader) {
                ...
                unpacked = (unpacked + 1);
                result = new MsgPack.Serialization.PolymorphicMemberTypeKnownType_Normal_PolymorphicGetOnlyPropertyAndConstructor(ctorArg0);
            }
            else {
                ...
                for (int i = 0; (i < itemsCount0); i = (i + 1)) {
                    ...
                    nullable0 = MsgPack.Serialization.UnpackHelpers.UnpackStringValue(unpacker, typeof(MsgPack.Serialization.PolymorphicMemberTypeKnownType_Normal_PolymorphicGetOnlyPropertyAndConstructor), "MemberName");
                    if (((nullable0 == null) 
                                == false)) {
                        key = nullable0;
                    }
                ...
                result = new MsgPack.Serialization.PolymorphicMemberTypeKnownType_Normal_PolymorphicGetOnlyPropertyAndConstructor(ctorArg00);
            }
            return result;
        }
