    ...
    public class MsgPack_Serialization_PolymorphicMemberTypeRuntimeType_Tuple_Tuple7AllPolymorphicReadWriteFieldSerializer : MsgPack.Serialization.MessagePackSerializer<MsgPack.Serialization.PolymorphicMemberTypeRuntimeType_Tuple_Tuple7AllPolymorphicReadWriteField> {
        ...
        protected internal override MsgPack.Serialization.PolymorphicMemberTypeRuntimeType_Tuple_Tuple7AllPolymorphicReadWriteField UnpackFromCore(MsgPack.Unpacker unpacker) {
            ...
            if (unpacker.IsArrayHeader) {
                ...
                if (((nullable == null) 
                            == false)) {
                    result.Tuple7AllPolymorphic = nullable;
                }
                unpacked = (unpacked + 1);
            }
            else {
                ...
                for (int i = 0; (i < itemsCount0); i = (i + 1)) {
                    ...
                    nullable0 = MsgPack.Serialization.UnpackHelpers.UnpackStringValue(unpacker, typeof(MsgPack.Serialization.PolymorphicMemberTypeRuntimeType_Tuple_Tuple7AllPolymorphicReadWriteField), "MemberName");
                    if (((nullable0 == null) 
                                == false)) {
                        key = nullable0;
                    }
                    ...
                    if ((key == "Tuple7AllPolymorphic")) {
                        ...
                        if (((nullable1 == null) 
                                    == false)) {
                            result.Tuple7AllPolymorphic = nullable1;
                        }
                    }
                    else {
                        unpacker.Skip();
