...
namespace MsgPack
{
	...
	public partial class UnpackingTest_Combinations_UInt64
	{
		...
		{
			var result = Unpacking.UnpackUInt64( new byte[] { 0xD3, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } );
		}
		...
		{
			var result = Unpacking.UnpackUInt64( new byte[] { 0xD3, 0xFF, 0xFF, 0xFF, 0xFF, 0x7F, 0xFF, 0xFF, 0xFF } );
		}
		...
		{
			var result = Unpacking.UnpackUInt64( new byte[] { 0xD3, 0xFF, 0xFF, 0xFF, 0xFF, 0x80, 0x00, 0x00, 0x00 } );
		}
		...
		{
			var result = Unpacking.UnpackUInt64( new byte[] { 0xD2, 0x80, 0x00, 0x00, 0x00 } );
		}
		...
		{
			var result = Unpacking.UnpackUInt64( new byte[] { 0xD3, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x7F, 0xFF } );
		}
		...
		{
			var result = Unpacking.UnpackUInt64( new byte[] { 0xD2, 0xFF, 0xFF, 0x7F, 0xFF } );
		}
		...
		{
			var result = Unpacking.UnpackUInt64( new byte[] { 0xD3, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x80, 0x00 } );
		}
		...
		{
			var result = Unpacking.UnpackUInt64( new byte[] { 0xD2, 0xFF, 0xFF, 0x80, 0x00 } );
		}
		...
		{
			var result = Unpacking.UnpackUInt64( new byte[] { 0xD1, 0x80, 0x00 } );
		}
		...
		{
			var result = Unpacking.UnpackUInt64( new byte[] { 0xD3, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x7F } );
		}
		...
		{
			var result = Unpacking.UnpackUInt64( new byte[] { 0xD2, 0xFF, 0xFF, 0xFF, 0x7F } );
		}
		...
		{
			var result = Unpacking.UnpackUInt64( new byte[] { 0xD1, 0xFF, 0x7F } );
		}
		...
		{
			var result = Unpacking.UnpackUInt64( new byte[] { 0xD3, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x80 } );
		}
		...
		{
			var result = Unpacking.UnpackUInt64( new byte[] { 0xD2, 0xFF, 0xFF, 0xFF, 0x80 } );
		}
		...
		{
			var result = Unpacking.UnpackUInt64( new byte[] { 0xD1, 0xFF, 0x80 } );
		}
		...
		{
			var result = Unpacking.UnpackUInt64( new byte[] { 0xD0, 0x80 } );
		}
		...
		{
			var result = Unpacking.UnpackUInt64( new byte[] { 0xD3, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xDF } );
		}
		...
		{
			var result = Unpacking.UnpackUInt64( new byte[] { 0xD2, 0xFF, 0xFF, 0xFF, 0xDF } );
		}
		...
		{
			var result = Unpacking.UnpackUInt64( new byte[] { 0xD1, 0xFF, 0xDF } );
		}
		...
		{
			var result = Unpacking.UnpackUInt64( new byte[] { 0xD0, 0xDF } );
		}
		...
		{
			var result = Unpacking.UnpackUInt64( new byte[] { 0xD3, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xE0 } );
		}
		...
		{
			var result = Unpacking.UnpackUInt64( new byte[] { 0xD2, 0xFF, 0xFF, 0xFF, 0xE0 } );
		}
		...
		{
			var result = Unpacking.UnpackUInt64( new byte[] { 0xD1, 0xFF, 0xE0 } );
		}
		...
		{
			var result = Unpacking.UnpackUInt64( new byte[] { 0xD0, 0xE0 } );
		}
		...
		{
			var result = Unpacking.UnpackUInt64( new byte[] { 0xE0 } );
		}
		...
		{
			var result = Unpacking.UnpackUInt64( new byte[] { 0xD3, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF } );
		}
		...
		{
			var result = Unpacking.UnpackUInt64( new byte[] { 0xD2, 0xFF, 0xFF, 0xFF, 0xFF } );
		}
		...
		{
			var result = Unpacking.UnpackUInt64( new byte[] { 0xD1, 0xFF, 0xFF } );
		}
		...
		{
			var result = Unpacking.UnpackUInt64( new byte[] { 0xD0, 0xFF } );
		}
		...
		{
			var result = Unpacking.UnpackUInt64( new byte[] { 0xFF } );
		}
		...
		{
			Unpacking.UnpackUInt64( new byte[ 0 ] );
		}
		...
		{
			Unpacking.UnpackUInt64( default( byte[] ) );
		}
		...
		{
			Unpacking.UnpackUInt64( default( byte[] ), 0 );
		}
		...
		{
			Unpacking.UnpackUInt64( new byte[]{ 0x1 }, -1 );
		}
		...
		{
			Unpacking.UnpackUInt64( new byte[ 0 ], 0 );
		}
		...
		{
			Unpacking.UnpackUInt64( default( Stream ) );
		}
		...
		{
			Unpacking.UnpackUInt64( new byte[] { 0xC0 } );
		}
		...
		{
			Unpacking.UnpackUInt64( new byte[] { 0xA0 } );
		}
	}
}