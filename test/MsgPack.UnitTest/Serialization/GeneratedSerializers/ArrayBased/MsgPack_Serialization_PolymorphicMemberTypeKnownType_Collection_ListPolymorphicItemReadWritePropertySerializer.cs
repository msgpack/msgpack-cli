...
namespace MsgPack.Serialization.GeneratedSerializers.ArrayBased {
    ...
    public class MsgPack_Serialization_PolymorphicMemberTypeKnownType_Collection_ListPolymorphicItemReadWritePropertySerializer : MsgPack.Serialization.MessagePackSerializer<MsgPack.Serialization.PolymorphicMemberTypeKnownType_Collection_ListPolymorphicItemReadWriteProperty> {
        ...
        public MsgPack_Serialization_PolymorphicMemberTypeKnownType_Collection_ListPolymorphicItemReadWritePropertySerializer(MsgPack.Serialization.SerializationContext context) : 
                base(context) {
        ...
        protected internal override void PackToCore(MsgPack.Packer packer, MsgPack.Serialization.PolymorphicMemberTypeKnownType_Collection_ListPolymorphicItemReadWriteProperty objectTree) {
            packer.PackArrayHeader(1);
            this._serializer0.PackTo(packer, objectTree.ListPolymorphicItem);
        }
        
        protected internal override MsgPack.Serialization.PolymorphicMemberTypeKnownType_Collection_ListPolymorphicItemReadWriteProperty UnpackFromCore(MsgPack.Unpacker unpacker) {
            MsgPack.Serialization.PolymorphicMemberTypeKnownType_Collection_ListPolymorphicItemReadWriteProperty result = default(MsgPack.Serialization.PolymorphicMemberTypeKnownType_Collection_ListPolymorphicItemReadWriteProperty);
            result = new MsgPack.Serialization.PolymorphicMemberTypeKnownType_Collection_ListPolymorphicItemReadWriteProperty();
            if (unpacker.IsArrayHeader) {
                ...
                for (int i = 0; (i < itemsCount0); i = (i + 1)) {
                    ...
                    nullable0 = MsgPack.Serialization.UnpackHelpers.UnpackStringValue(unpacker, typeof(MsgPack.Serialization.PolymorphicMemberTypeKnownType_Collection_ListPolymorphicItemReadWriteProperty), "MemberName");
                    if (((nullable0 == null) 
                                == false)) {
                        key = nullable0;
                    }
