        ...
        protected internal override MsgPack.Serialization.PolymorphicMemberTypeRuntimeType_Normal_StringPrivateSetterPropertyAndConstructor UnpackFromCore(MsgPack.Unpacker unpacker) {
            ...
            if (unpacker.IsArrayHeader) {
                ...
                if ((unpacked < itemsCount)) {
                    nullable = MsgPack.Serialization.UnpackHelpers.UnpackStringValue(unpacker, typeof(MsgPack.Serialization.PolymorphicMemberTypeRuntimeType_Normal_StringPrivateSetterPropertyAndConstructor), "System.String String");
                }
                if (((nullable == null) 
                            == false)) {
                    this._methodBasePolymorphicMemberTypeRuntimeType_Normal_StringPrivateSetterPropertyAndConstructor_set_String0.Invoke(result, new object[] {
                                nullable});
                }
                unpacked = (unpacked + 1);
            }
                ...
                for (int i = 0; (i < itemsCount0); i = (i + 1)) {
                    ...
                    nullable0 = MsgPack.Serialization.UnpackHelpers.UnpackStringValue(unpacker, typeof(MsgPack.Serialization.PolymorphicMemberTypeRuntimeType_Normal_StringPrivateSetterPropertyAndConstructor), "MemberName");
                    if (((nullable0 == null) 
                                == false)) {
                        key = nullable0;
                    }
                    ...
                    if ((key == "String")) {
                        ...
                        nullable1 = MsgPack.Serialization.UnpackHelpers.UnpackStringValue(unpacker, typeof(MsgPack.Serialization.PolymorphicMemberTypeRuntimeType_Normal_StringPrivateSetterPropertyAndConstructor), "System.String String");
                        if (((nullable1 == null) 
                                    == false)) {
                            this._methodBasePolymorphicMemberTypeRuntimeType_Normal_StringPrivateSetterPropertyAndConstructor_set_String0.Invoke(result, new object[] {
                                        nullable1});
