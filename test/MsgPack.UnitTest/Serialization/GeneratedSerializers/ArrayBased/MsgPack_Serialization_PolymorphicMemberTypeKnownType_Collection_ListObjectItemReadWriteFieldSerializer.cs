...
namespace MsgPack.Serialization.GeneratedSerializers.ArrayBased {
    ...
    public class MsgPack_Serialization_PolymorphicMemberTypeKnownType_Collection_ListObjectItemReadWriteFieldSerializer : MsgPack.Serialization.MessagePackSerializer<MsgPack.Serialization.PolymorphicMemberTypeKnownType_Collection_ListObjectItemReadWriteField> {
        
        private MsgPack.Serialization.MessagePackSerializer<System.Collections.Generic.IList<object>> _serializer0;
        
        public MsgPack_Serialization_PolymorphicMemberTypeKnownType_Collection_ListObjectItemReadWriteFieldSerializer(MsgPack.Serialization.SerializationContext context) : 
                base(context) {
        ...
        protected internal override void PackToCore(MsgPack.Packer packer, MsgPack.Serialization.PolymorphicMemberTypeKnownType_Collection_ListObjectItemReadWriteField objectTree) {
            packer.PackArrayHeader(1);
            this._serializer0.PackTo(packer, objectTree.ListObjectItem);
        }
        
        protected internal override MsgPack.Serialization.PolymorphicMemberTypeKnownType_Collection_ListObjectItemReadWriteField UnpackFromCore(MsgPack.Unpacker unpacker) {
            MsgPack.Serialization.PolymorphicMemberTypeKnownType_Collection_ListObjectItemReadWriteField result = default(MsgPack.Serialization.PolymorphicMemberTypeKnownType_Collection_ListObjectItemReadWriteField);
            result = new MsgPack.Serialization.PolymorphicMemberTypeKnownType_Collection_ListObjectItemReadWriteField();
            if (unpacker.IsArrayHeader) {
                ...
                for (int i = 0; (i < itemsCount0); i = (i + 1)) {
                    ...
                    nullable0 = MsgPack.Serialization.UnpackHelpers.UnpackStringValue(unpacker, typeof(MsgPack.Serialization.PolymorphicMemberTypeKnownType_Collection_ListObjectItemReadWriteField), "MemberName");
                    if (((nullable0 == null) 
                                == false)) {
                        key = nullable0;
                    }
