...
namespace MsgPack.Serialization.GeneratedSerializers.MapBased {
    ...
    public class MsgPack_Serialization_DataMamberClassSerializer : MsgPack.Serialization.MessagePackSerializer<MsgPack.Serialization.DataMamberClass> {
        ...
        protected internal override void PackToCore(MsgPack.Packer packer, MsgPack.Serialization.DataMamberClass objectTree) {
            ...
            this._serializer1.PackTo(packer, ((int)(this._methodBaseDataMamberClass_get_NonPublicProperty44.Invoke(objectTree, null))));
            this._serializer0.PackTo(packer, "NonPublicField");
            this._serializer1.PackTo(packer, ((int)(this._fieldDataMamberClass_NonPublicField2.GetValue(objectTree))));
            ...
            this._serializer1.PackTo(packer, ((int)(this._fieldDataMamberClass_NonSerializedNonPublicField3.GetValue(objectTree))));
