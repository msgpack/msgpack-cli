...
namespace MsgPack.Serialization.GeneratedSerializers.MapBased {
    ...
    public class MsgPack_Serialization_ComplexTypeWithDataContractWithOrderSerializer : MsgPack.Serialization.MessagePackSerializer<MsgPack.Serialization.ComplexTypeWithDataContractWithOrder> {
        ...
        public MsgPack_Serialization_ComplexTypeWithDataContractWithOrderSerializer(MsgPack.Serialization.SerializationContext context) : 
            ...
            this._serializer1 = context.GetSerializer<System.Uri>();
            this._serializer2 = context.GetSerializer<byte[]>();
            this._serializer3 = context.GetSerializer<System.DateTime>();
            this._serializer4 = context.GetSerializer<System.Collections.Generic.Dictionary<System.DateTime, string>>();
                ...
                if (((nullable2 == null) 
                    ...
                    try {
                        ...
                        ; enumerator.MoveNext(); 
                            ...
                            ((System.Collections.Generic.Dictionary<System.DateTime, string>)(this._methodBaseComplexTypeWithDataContractWithOrder_get_History37.Invoke(result, null))).Add(current.Key, current.Value);
                        }
                    }
                    finally {
                        enumerator.Dispose();
                        ...
                        if (((nullable7 == null) 
                            ...
                            try {
                                ...
                                ; enumerator0.MoveNext(); 
                                    ...
                                    ((System.Collections.Generic.Dictionary<System.DateTime, string>)(this._methodBaseComplexTypeWithDataContractWithOrder_get_History37.Invoke(result, null))).Add(current0.Key, current0.Value);
                                }
                            }
                            finally {
                                enumerator0.Dispose();
