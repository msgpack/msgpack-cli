...
namespace MsgPack.Serialization.GeneratedSerializers.MapBased {
    ...
    public class MsgPack_Serialization_SimpleCollection_1_System_DateTime_Serializer : MsgPack.Serialization.MessagePackSerializer<MsgPack.Serialization.SimpleCollection<System.DateTime>> {
        ...
        public MsgPack_Serialization_SimpleCollection_1_System_DateTime_Serializer(MsgPack.Serialization.SerializationContext context) : 
                base(MsgPack_Serialization_SimpleCollection_1_System_DateTime_Serializer.@__Conditional((context != null), context, MsgPack.Serialization.SerializationContext.Default).CompatibilityOptions.PackerCompatibilityOptions) {
            MsgPack.Serialization.SerializationContext safeContext = MsgPack_Serialization_SimpleCollection_1_System_DateTime_Serializer.@__Conditional((context != null), context, MsgPack.Serialization.SerializationContext.Default);
