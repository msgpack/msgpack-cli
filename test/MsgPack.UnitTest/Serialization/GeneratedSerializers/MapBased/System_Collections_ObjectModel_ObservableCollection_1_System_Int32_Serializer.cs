...
namespace MsgPack.Serialization.GeneratedSerializers.MapBased {
    ...
    public class System_Collections_ObjectModel_ObservableCollection_1_System_Int32_Serializer : MsgPack.Serialization.MessagePackSerializer<System.Collections.ObjectModel.ObservableCollection<int>> {
        ...
        public System_Collections_ObjectModel_ObservableCollection_1_System_Int32_Serializer(MsgPack.Serialization.SerializationContext context) : 
                base(System_Collections_ObjectModel_ObservableCollection_1_System_Int32_Serializer.@__Conditional((context != null), context, MsgPack.Serialization.SerializationContext.Default).CompatibilityOptions.PackerCompatibilityOptions) {
            MsgPack.Serialization.SerializationContext safeContext = System_Collections_ObjectModel_ObservableCollection_1_System_Int32_Serializer.@__Conditional((context != null), context, MsgPack.Serialization.SerializationContext.Default);
