    ...
    public class MsgPack_Serialization_PolymorphicMemberTypeKnownType_ReferenceGetOnlyPropertyAndConstructorAsObjectSerializer : MsgPack.Serialization.MessagePackSerializer<MsgPack.Serialization.PolymorphicMemberTypeKnownType_ReferenceGetOnlyPropertyAndConstructorAsObject> {
        ...
        protected internal override MsgPack.Serialization.PolymorphicMemberTypeKnownType_ReferenceGetOnlyPropertyAndConstructorAsObject UnpackFromCore(MsgPack.Unpacker unpacker) {
            ...
            if (unpacker.IsArrayHeader) {
                ...
                unpacked = (unpacked + 1);
                result = new MsgPack.Serialization.PolymorphicMemberTypeKnownType_ReferenceGetOnlyPropertyAndConstructorAsObject(ctorArg0);
            }
            else {
                ...
                for (int i = 0; (i < itemsCount0); i = (i + 1)) {
                    ...
                    nullable0 = MsgPack.Serialization.UnpackHelpers.UnpackStringValue(unpacker, typeof(MsgPack.Serialization.PolymorphicMemberTypeKnownType_ReferenceGetOnlyPropertyAndConstructorAsObject), "MemberName");
                    if (((nullable0 == null) 
                                == false)) {
                        key = nullable0;
                    }
                ...
                result = new MsgPack.Serialization.PolymorphicMemberTypeKnownType_ReferenceGetOnlyPropertyAndConstructorAsObject(ctorArg00);
            }
            return result;
        }
