...
namespace MsgPack.Serialization.GeneratedSerializers.MapBased {
    ...
    public class MsgPack_Serialization_PolymorphicMemberTypeMixedSerializer : MsgPack.Serialization.MessagePackSerializer<MsgPack.Serialization.PolymorphicMemberTypeMixed> {
        ...
        public MsgPack_Serialization_PolymorphicMemberTypeMixedSerializer(MsgPack.Serialization.SerializationContext context) : 
            ...
            System.Collections.Generic.Dictionary<byte, System.Type> valuesSchema2TypeMap0 = default(System.Collections.Generic.Dictionary<byte, System.Type>);
            valuesSchema2TypeMap0 = new System.Collections.Generic.Dictionary<byte, System.Type>(2);
            ...
            System.Collections.Generic.Dictionary<byte, System.Type> valuesSchema3TypeMap0 = default(System.Collections.Generic.Dictionary<byte, System.Type>);
            valuesSchema3TypeMap0 = new System.Collections.Generic.Dictionary<byte, System.Type>(2);
            ...
            System.Collections.Generic.Dictionary<byte, System.Type> typeMap2 = default(System.Collections.Generic.Dictionary<byte, System.Type>);
            typeMap2 = new System.Collections.Generic.Dictionary<byte, System.Type>(2);
            typeMap2 = new System.Collections.Generic.Dictionary<byte, System.Type>(2);
            ...
            System.Collections.Generic.Dictionary<byte, System.Type> typeMap3 = default(System.Collections.Generic.Dictionary<byte, System.Type>);
            typeMap3 = new System.Collections.Generic.Dictionary<byte, System.Type>(2);
            typeMap3 = new System.Collections.Generic.Dictionary<byte, System.Type>(2);
            ...
            System.Collections.Generic.Dictionary<byte, System.Type> typeMap4 = default(System.Collections.Generic.Dictionary<byte, System.Type>);
            typeMap4 = new System.Collections.Generic.Dictionary<byte, System.Type>(2);
            ...
            System.Collections.Generic.Dictionary<byte, System.Type> typeMap5 = default(System.Collections.Generic.Dictionary<byte, System.Type>);
            typeMap5 = new System.Collections.Generic.Dictionary<byte, System.Type>(2);
        ...
        protected internal override MsgPack.Serialization.PolymorphicMemberTypeMixed UnpackFromCore(MsgPack.Unpacker unpacker) {
            ...
            if (unpacker.IsArrayHeader) {
                ...
                unpacked = (unpacked + 1);
                System.Tuple<string, MsgPack.Serialization.FileSystemEntry, MsgPack.Serialization.FileSystemEntry, object> nullable11 = default(System.Tuple<string, MsgPack.Serialization.FileSystemEntry, MsgPack.Serialization.FileSystemEntry, object>);
                if ((unpacked < itemsCount)) {
                    if ((unpacker.Read() == false)) {
                    ...
                    if (((unpacker.IsArrayHeader == false) 
                                && (unpacker.IsMapHeader == false))) {
                        nullable11 = this._serializer22.UnpackFrom(unpacker);
                    }
                    else {
                        MsgPack.Unpacker disposable10 = default(MsgPack.Unpacker);
                        disposable10 = unpacker.ReadSubtree();
                        try {
                            nullable11 = this._serializer22.UnpackFrom(disposable10);
                        }
                        finally {
                ...
                for (int i = 0; (i < itemsCount0); i = (i + 1)) {
                    ...
                    if ((key == "Tuple")) {
                        System.Tuple<string, MsgPack.Serialization.FileSystemEntry, MsgPack.Serialization.FileSystemEntry, object> nullable25 = default(System.Tuple<string, MsgPack.Serialization.FileSystemEntry, MsgPack.Serialization.FileSystemEntry, object>);
                        if ((unpacker.Read() == false)) {
                            throw MsgPack.Serialization.SerializationExceptions.NewMissingItem(i);
                        }
                        if (((unpacker.IsArrayHeader == false) 
                                    && (unpacker.IsMapHeader == false))) {
                            nullable25 = this._serializer22.UnpackFrom(unpacker);
                        }
                        else {
                            MsgPack.Unpacker disposable22 = default(MsgPack.Unpacker);
                            disposable22 = unpacker.ReadSubtree();
                            try {
                                nullable25 = this._serializer22.UnpackFrom(disposable22);
                            }
                            finally {
