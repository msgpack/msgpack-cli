...
namespace MsgPack.Serialization.GeneratedSerializers.MapBased {
    ...
    public class System_Collections_ObjectModel_ObservableCollection_1_System_DateTime_Serializer : MsgPack.Serialization.MessagePackSerializer<System.Collections.ObjectModel.ObservableCollection<System.DateTime>> {
        ...
        public System_Collections_ObjectModel_ObservableCollection_1_System_DateTime_Serializer(MsgPack.Serialization.SerializationContext context) : 
                base(System_Collections_ObjectModel_ObservableCollection_1_System_DateTime_Serializer.@__Conditional((context != null), context, MsgPack.Serialization.SerializationContext.Default).CompatibilityOptions.PackerCompatibilityOptions) {
            MsgPack.Serialization.SerializationContext safeContext = System_Collections_ObjectModel_ObservableCollection_1_System_DateTime_Serializer.@__Conditional((context != null), context, MsgPack.Serialization.SerializationContext.Default);
        ...
        protected internal override void PackToCore(MsgPack.Packer packer, System.Collections.ObjectModel.ObservableCollection<System.DateTime> objectTree) {
            ...
            try {
                ...
                ; enumerator.MoveNext(); 
                    ...
                    this._serializer6.PackTo(packer, current);
                }
            }
            finally {
                enumerator.Dispose();
            ...
            for (int i = 0; (i < count); i = (i + 1)) {
                ...
                if (nullable.HasValue) {
                    ...
                    throw MsgPack.Serialization.SerializationExceptions.NewValueTypeCannotBeNull(string.Format(System.Globalization.CultureInfo.InvariantCulture, "item{0}", new object[] {
                                    ((object)(i))}), typeof(System.DateTime), typeof(System.Collections.ObjectModel.ObservableCollection<System.DateTime>));
                }
            }
        }
