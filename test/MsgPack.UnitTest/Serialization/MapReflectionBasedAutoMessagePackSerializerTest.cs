...
namespace MsgPack.Serialization
{
	...
	public class MapReflectionBasedReflectionMessagePackSerializerTest
	{
		...
		{
#if !UNITY
			return new SerializationContext { SerializationMethod = SerializationMethod.Map, EmitterFlavor = EmitterFlavor.ReflectionBased };
#else
			var context = new SerializationContext { SerializationMethod = SerializationMethod.Map, EmitterFlavor = EmitterFlavor.ReflectionBased };
		...
		{
			return new SerializationContext( compatibilityOptions ) { SerializationMethod = SerializationMethod.Map, EmitterFlavor = EmitterFlavor.ReflectionBased };
		}
