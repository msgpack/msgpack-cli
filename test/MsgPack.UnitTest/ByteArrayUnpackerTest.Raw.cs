...
#pragma warning restore 612,618
		...
		[Test]
		public void TestRead_FixStr_31_AsString_Limited()
		{
			var data =
				new byte[] { 0xBF }
				.Concat( Enumerable.Repeat( ( byte )'A', 31 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestReadString_FixStr_31_Limited()
		{
			var data =
				new byte[] { 0xBF }
				.Concat( Enumerable.Repeat( ( byte )'A', 31 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestRead_Str8_255_AsString_Limited()
		{
			var data =
				new byte[] { 0xD9, 0xFF }
				.Concat( Enumerable.Repeat( ( byte )'A', 255 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestReadString_Str8_255_Limited()
		{
			var data =
				new byte[] { 0xD9, 0xFF }
				.Concat( Enumerable.Repeat( ( byte )'A', 255 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestRead_Str16_65535_AsString_Limited()
		{
			var data =
				new byte[] { 0xDA, 0xFF, 0xFF }
				.Concat( Enumerable.Repeat( ( byte )'A', 65535 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestReadString_Str16_65535_Limited()
		{
			var data =
				new byte[] { 0xDA, 0xFF, 0xFF }
				.Concat( Enumerable.Repeat( ( byte )'A', 65535 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestRead_Str32_65536_AsString_Limited()
		{
			var data =
				new byte[] { 0xDB, 0, 1, 0, 0 }
				.Concat( Enumerable.Repeat( ( byte )'A', 65536 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestReadString_Str32_65536_Limited()
		{
			var data =
				new byte[] { 0xDB, 0, 1, 0, 0 }
				.Concat( Enumerable.Repeat( ( byte )'A', 65536 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestRead_Bin8_255_AsString_Limited()
		{
			var data =
				new byte[] { 0xC4, 0xFF }
				.Concat( Enumerable.Repeat( ( byte )'A', 255 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestReadString_Bin8_255_Limited()
		{
			var data =
				new byte[] { 0xC4, 0xFF }
				.Concat( Enumerable.Repeat( ( byte )'A', 255 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestRead_Bin16_65535_AsString_Limited()
		{
			var data =
				new byte[] { 0xC5, 0xFF, 0xFF }
				.Concat( Enumerable.Repeat( ( byte )'A', 65535 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestReadString_Bin16_65535_Limited()
		{
			var data =
				new byte[] { 0xC5, 0xFF, 0xFF }
				.Concat( Enumerable.Repeat( ( byte )'A', 65535 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestRead_Bin32_65536_AsString_Limited()
		{
			var data =
				new byte[] { 0xC6, 0, 1, 0, 0 }
				.Concat( Enumerable.Repeat( ( byte )'A', 65536 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestReadString_Bin32_65536_Limited()
		{
			var data =
				new byte[] { 0xC6, 0, 1, 0, 0 }
				.Concat( Enumerable.Repeat( ( byte )'A', 65536 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestRead_FixStr_31_AsBinary_Limited()
		{
			var data =
				new byte[] { 0xBF }
				.Concat( Enumerable.Repeat( ( byte )0xFF, 31 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestReadBinary_FixStr_31_Limited()
		{
			var data =
				new byte[] { 0xBF }
				.Concat( Enumerable.Repeat( ( byte )0xFF, 31 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestRead_Str8_255_AsBinary_Limited()
		{
			var data =
				new byte[] { 0xD9, 0xFF }
				.Concat( Enumerable.Repeat( ( byte )0xFF, 255 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestReadBinary_Str8_255_Limited()
		{
			var data =
				new byte[] { 0xD9, 0xFF }
				.Concat( Enumerable.Repeat( ( byte )0xFF, 255 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestRead_Str16_65535_AsBinary_Limited()
		{
			var data =
				new byte[] { 0xDA, 0xFF, 0xFF }
				.Concat( Enumerable.Repeat( ( byte )0xFF, 65535 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestReadBinary_Str16_65535_Limited()
		{
			var data =
				new byte[] { 0xDA, 0xFF, 0xFF }
				.Concat( Enumerable.Repeat( ( byte )0xFF, 65535 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestRead_Str32_65536_AsBinary_Limited()
		{
			var data =
				new byte[] { 0xDB, 0, 1, 0, 0 }
				.Concat( Enumerable.Repeat( ( byte )0xFF, 65536 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestReadBinary_Str32_65536_Limited()
		{
			var data =
				new byte[] { 0xDB, 0, 1, 0, 0 }
				.Concat( Enumerable.Repeat( ( byte )0xFF, 65536 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestRead_Bin8_255_AsBinary_Limited()
		{
			var data =
				new byte[] { 0xC4, 0xFF }
				.Concat( Enumerable.Repeat( ( byte )0xFF, 255 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestReadBinary_Bin8_255_Limited()
		{
			var data =
				new byte[] { 0xC4, 0xFF }
				.Concat( Enumerable.Repeat( ( byte )0xFF, 255 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestRead_Bin16_65535_AsBinary_Limited()
		{
			var data =
				new byte[] { 0xC5, 0xFF, 0xFF }
				.Concat( Enumerable.Repeat( ( byte )0xFF, 65535 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestReadBinary_Bin16_65535_Limited()
		{
			var data =
				new byte[] { 0xC5, 0xFF, 0xFF }
				.Concat( Enumerable.Repeat( ( byte )0xFF, 65535 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestRead_Bin32_65536_AsBinary_Limited()
		{
			var data =
				new byte[] { 0xC6, 0, 1, 0, 0 }
				.Concat( Enumerable.Repeat( ( byte )0xFF, 65536 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestReadBinary_Bin32_65536_Limited()
		{
			var data =
				new byte[] { 0xC6, 0, 1, 0, 0 }
				.Concat( Enumerable.Repeat( ( byte )0xFF, 65536 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestRead_FixStr_31Async_AsString_Limited()
		{
			var data =
				new byte[] { 0xBF }
				.Concat( Enumerable.Repeat( ( byte )'A', 31 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestReadString_FixStrAsync_31_Limited()
		{
			var data =
				new byte[] { 0xBF }
				.Concat( Enumerable.Repeat( ( byte )'A', 31 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestRead_Str8_255Async_AsString_Limited()
		{
			var data =
				new byte[] { 0xD9, 0xFF }
				.Concat( Enumerable.Repeat( ( byte )'A', 255 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestReadString_Str8Async_255_Limited()
		{
			var data =
				new byte[] { 0xD9, 0xFF }
				.Concat( Enumerable.Repeat( ( byte )'A', 255 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestRead_Str16_65535Async_AsString_Limited()
		{
			var data =
				new byte[] { 0xDA, 0xFF, 0xFF }
				.Concat( Enumerable.Repeat( ( byte )'A', 65535 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestReadString_Str16Async_65535_Limited()
		{
			var data =
				new byte[] { 0xDA, 0xFF, 0xFF }
				.Concat( Enumerable.Repeat( ( byte )'A', 65535 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestRead_Str32_65536Async_AsString_Limited()
		{
			var data =
				new byte[] { 0xDB, 0, 1, 0, 0 }
				.Concat( Enumerable.Repeat( ( byte )'A', 65536 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestReadString_Str32Async_65536_Limited()
		{
			var data =
				new byte[] { 0xDB, 0, 1, 0, 0 }
				.Concat( Enumerable.Repeat( ( byte )'A', 65536 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestRead_Bin8_255Async_AsString_Limited()
		{
			var data =
				new byte[] { 0xC4, 0xFF }
				.Concat( Enumerable.Repeat( ( byte )'A', 255 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestReadString_Bin8Async_255_Limited()
		{
			var data =
				new byte[] { 0xC4, 0xFF }
				.Concat( Enumerable.Repeat( ( byte )'A', 255 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestRead_Bin16_65535Async_AsString_Limited()
		{
			var data =
				new byte[] { 0xC5, 0xFF, 0xFF }
				.Concat( Enumerable.Repeat( ( byte )'A', 65535 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestReadString_Bin16Async_65535_Limited()
		{
			var data =
				new byte[] { 0xC5, 0xFF, 0xFF }
				.Concat( Enumerable.Repeat( ( byte )'A', 65535 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestRead_Bin32_65536Async_AsString_Limited()
		{
			var data =
				new byte[] { 0xC6, 0, 1, 0, 0 }
				.Concat( Enumerable.Repeat( ( byte )'A', 65536 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestReadString_Bin32Async_65536_Limited()
		{
			var data =
				new byte[] { 0xC6, 0, 1, 0, 0 }
				.Concat( Enumerable.Repeat( ( byte )'A', 65536 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestRead_FixStr_31Async_AsBinary_Limited()
		{
			var data =
				new byte[] { 0xBF }
				.Concat( Enumerable.Repeat( ( byte )0xFF, 31 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestReadBinary_FixStrAsync_31_Limited()
		{
			var data =
				new byte[] { 0xBF }
				.Concat( Enumerable.Repeat( ( byte )0xFF, 31 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestRead_Str8_255Async_AsBinary_Limited()
		{
			var data =
				new byte[] { 0xD9, 0xFF }
				.Concat( Enumerable.Repeat( ( byte )0xFF, 255 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestReadBinary_Str8Async_255_Limited()
		{
			var data =
				new byte[] { 0xD9, 0xFF }
				.Concat( Enumerable.Repeat( ( byte )0xFF, 255 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestRead_Str16_65535Async_AsBinary_Limited()
		{
			var data =
				new byte[] { 0xDA, 0xFF, 0xFF }
				.Concat( Enumerable.Repeat( ( byte )0xFF, 65535 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestReadBinary_Str16Async_65535_Limited()
		{
			var data =
				new byte[] { 0xDA, 0xFF, 0xFF }
				.Concat( Enumerable.Repeat( ( byte )0xFF, 65535 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestRead_Str32_65536Async_AsBinary_Limited()
		{
			var data =
				new byte[] { 0xDB, 0, 1, 0, 0 }
				.Concat( Enumerable.Repeat( ( byte )0xFF, 65536 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestReadBinary_Str32Async_65536_Limited()
		{
			var data =
				new byte[] { 0xDB, 0, 1, 0, 0 }
				.Concat( Enumerable.Repeat( ( byte )0xFF, 65536 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestRead_Bin8_255Async_AsBinary_Limited()
		{
			var data =
				new byte[] { 0xC4, 0xFF }
				.Concat( Enumerable.Repeat( ( byte )0xFF, 255 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestReadBinary_Bin8Async_255_Limited()
		{
			var data =
				new byte[] { 0xC4, 0xFF }
				.Concat( Enumerable.Repeat( ( byte )0xFF, 255 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestRead_Bin16_65535Async_AsBinary_Limited()
		{
			var data =
				new byte[] { 0xC5, 0xFF, 0xFF }
				.Concat( Enumerable.Repeat( ( byte )0xFF, 65535 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestReadBinary_Bin16Async_65535_Limited()
		{
			var data =
				new byte[] { 0xC5, 0xFF, 0xFF }
				.Concat( Enumerable.Repeat( ( byte )0xFF, 65535 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestRead_Bin32_65536Async_AsBinary_Limited()
		{
			var data =
				new byte[] { 0xC6, 0, 1, 0, 0 }
				.Concat( Enumerable.Repeat( ( byte )0xFF, 65536 ) ).ToArray();
...
#pragma warning restore 612,618
		...
		[Test]
		public void TestReadBinary_Bin32Async_65536_Limited()
		{
			var data =
				new byte[] { 0xC6, 0, 1, 0, 0 }
				.Concat( Enumerable.Repeat( ( byte )0xFF, 65536 ) ).ToArray();
