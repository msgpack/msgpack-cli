...
namespace MsgPack
{
	...
	public class FastByteArrayUnpackerTest : ByteArrayUnpackerTest
	{
		...
		{
			return Unpacker.Create( source, new UnpackerOptions { ValidationLevel = UnpackerValidationLevel.None } );
		}

		protected override ByteArrayUnpacker CreateUnpacker( IList<ArraySegment<byte>> sources )
		{
			return Unpacker.Create( sources, 0, 0, new UnpackerOptions { ValidationLevel = UnpackerValidationLevel.None } );
		}
	}
}
